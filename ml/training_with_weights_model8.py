...
from sklearn.utils import class_weight  # ✅ Add this if missing
...
for N_TIMESTEPS in tqdm(month_list):
    ...
    df = pd.read_csv(data_path / f'{N_TIMESTEPS}.csv')
    ...
    class_weights = {0: weights[0], 1: weights[1]}  # Store in dictionary
    ...
    model.fit(X_train, y_train, batch_size=10, epochs=100, verbose=1, class_weight=class_weights)
    # if N_TIMESTEPS > 27:
    model.save(models_path / f'modelWeighted_{N_TIMESTEPS}.h5')
